-- copy this file and replace the 2011b tags with whichever semester
-- you are creating the structure for.

SET SQL_MODE="NO_AUTO_VALUE_ON_ZERO";

CREATE TABLE IF NOT EXISTS `2011b_proposal` (
...
CREATE TABLE IF NOT EXISTS `2011b_author` (
  `proposalid` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `2011b_source` (
  `proposalid` bigint(20) NOT NULL DEFAULT '0',
  `numb` bigint(20) NOT NULL DEFAULT '1',
  `name` text COLLATE utf8_unicode_ci,
