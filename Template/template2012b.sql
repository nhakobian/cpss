-- copy this file and replace the 2012b tags with whichever semester
-- you are creating the structure for.

SET SQL_MODE="NO_AUTO_VALUE_ON_ZERO";

CREATE TABLE IF NOT EXISTS `2012b_proposal` (
...
CREATE TABLE IF NOT EXISTS `2012b_author` (
  `proposalid` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `2012b_source` (
  `proposalid` bigint(20) NOT NULL DEFAULT '0',
  `numb` bigint(20) NOT NULL DEFAULT '1',
  `name` text COLLATE utf8_unicode_ci,
